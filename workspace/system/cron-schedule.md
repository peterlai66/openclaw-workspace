...
(crontab -l 2>/dev/null; cat "/home/pclaw/.openclaw/workspace/system/cron-schedule.md" | grep -A 2 "每小時執行" | tail -2) | crontab -
(crontab -l 2>/dev/null; cat "/home/pclaw/.openclaw/workspace/system/cron-schedule.md" | grep -A 2 "每3小時執行" | tail -4) | crontab -
(crontab -l 2>/dev/null; cat "/home/pclaw/.openclaw/workspace/system/cron-schedule.md" | grep -A 2 "每6小時執行" | tail -4) | crontab -
(crontab -l 2>/dev/null; cat "/home/pclaw/.openclaw/workspace/system/cron-schedule.md" | grep -A 2 "每天執行" | tail -6) | crontab -
```
